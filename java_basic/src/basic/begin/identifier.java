...
//		int 700 = 365;
//		int 7number = 7;  숫자로 시작해도 변수가 선언이 안된다.
		//숫자가 변수명 앞에만 오지 않는다면 변수 선언 가능
		int number7 = 64534;
		int num7ber = 44345;
		
		
		//3. 식별자 이름에 공백을 포함할 수 없습니다.
//		int my birth day = 154896; 공백이 있어서 선언이 안됨
		int mybirthday = 6165654;
		int myBirthDay = 6565614; //camel case 
...
//		String class = "클래스";
		String Class = "클래스"; //사용이 가능하나 권장하지 않습니다.
