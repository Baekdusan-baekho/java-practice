...
public class ListQuiz02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		List<User> userlist = new ArrayList<>(); // 객체를 저장한다
		...
		*/
		...
		userlist.add(new User("홍길동", 20)); //객체를 저장해야 한다.
...
//			}
	...
	private static void user(List<String> user, List<String> user2, List<Integer> user1) {
		// TODO Auto-generated method stub
		
	}

	private static void user(List<String> user, int i) {
		// TODO Auto-generated method stub
